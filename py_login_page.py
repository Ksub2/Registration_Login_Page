...
# Create content frame (for username and password input)
...
#creating a function to display the Register frame
...
#creating a function to make a user login
...
#creating a function to display the login frame
def go_to_login():
...
#create a function to check if the username already exist or not
